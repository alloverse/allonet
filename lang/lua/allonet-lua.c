...
static void state_callback(alloclient *client, allo_state *state, allo_entity_vec new_entities, allo_entity_vec deleted_entities, allo_component_vec new_components, allo_component_vec updated_components, allo_component_vec deleted_components);
