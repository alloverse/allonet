...
allo_m4x4 allosim_stick_movement(Entity* avatar, Entity* head, const allo_client_intent *intent, double dt, bool write, allo_state_diff *diff)
{
  ...
  allo_m4x4 old_transform = GetEntityTransform(avatar);
  allo_m4x4 heading_transform = GetEntityTransform(head);
